...
@property NSInteger indexOfStateSelected  /** index of state selected in the table to be passed to the MTGViewController*/;
@property NSInteger indexOfSession /** index of session for which we open saved states */;
@property MTGSavedScale *sessionUsed  /** session which we are using */;

/**
	fills the variables with data from NSUserDefaults
 */
-(void)dataFill;
